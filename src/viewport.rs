...
pub fn viewports() {
    ...
    let top_right_view_port = make_rect((SCREEN_WIDTH as i32)/ 2, 0,
                                        SCREEN_WIDTH / 2, SCREEN_HEIGHT/2);
    let bottom_view_port = make_rect(0, (SCREEN_HEIGHT as i32)/ 2,
...
fn make_rect(x: i32, y: i32, w: u32, h: u32) -> Rect {
    ::sdl2::rect::Rect::new(x, y, w, h).ok().expect("sdl create rect failed")
