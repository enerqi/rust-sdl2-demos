...
fn main() {
    ...
    let demos_info = [(sw::simple_window as fn(),
                      ...
                      (ss::simple_surface, "Render a surface image onto a window"),
                      (sr::simple_reblitted,
                       "Render a surface image onto a window, ensure reblitted if repainting \
                        required"),
                      ...
                      (v::viewports, "Drawing a texture to multiple view ports."),
                      (ck::color_keying,
